<template>
    <div>
        ...
        <div class="bg-white flex justify-center">
            <div class="bg-primary-blue max-w-4xl w-full mt-8 mb-8 p-8 rounded-lg shadow-2xl">
        ...
        <!--<div class="max-w-4xl w-full mx-auto">
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <CardActivity v-for="activity in activities" :key="activity.id" :title="activity.nom" :description="activity.description" />
            </div>
        </div>-->
    </div>
</template>
